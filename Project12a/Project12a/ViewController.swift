...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let encodedPeople = UserDefaults.standard.data(forKey: "people") {
            if let arhivedPeople = try? NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(encodedPeople) as? [Person] {
                people = arhivedPeople
            }
        }
    }
...
//        return Bundle.main.resourceURL!
    ...
    private func save() {
        if let encodedPeople = try? NSKeyedArchiver.archivedData(withRootObject: people, requiringSecureCoding: false) {
